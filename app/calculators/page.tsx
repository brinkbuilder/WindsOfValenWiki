...
export const metadata: Metadata = {
  title: 'Calculators',
  description: 'Winds of Valen multi-item crafting, skill, Gilded potion batch and time, Smithing material and time, combat experience, max hit, accuracy, and defence calculators.',
};
...
export default async function CalculatorsPage({ searchParams }: { searchParams: Promise<{ tab?: string | string[]; skill?: string | string[] }> }) {
  ...
  const initialTab = rawTab === 'crafting' || rawTab === 'combat' || rawTab === 'accuracy' || rawTab === 'max-hit' ? rawTab : 'skill';
  return (
    <main className="calculator-page classic-content-page">
      ...
      <header className="classic-page-heading">
        ...
        <span>Build combined crafting lists, plan level 100 goals, calculate potion batches and Smithing time, estimate combat experience, and compare maximum hits, accuracy, and defence.</span>
      </header>
