...
export const wikiSources: WikiSourceDefinition[] = [
  {
    ...
    role: 'Current community guides and recent game information.',
  ...
  },
  {
    ...
    shortName: 'Older community wiki',
    role: 'Older guides, historical mechanics, maps, calculators, and images.',
